(function (global, factory) {
  ...
  var Header = /*@__PURE__*/getDefaultExportFromCjs(bundle$d.exports);
  ...
  var TimeStampImage = /*#__PURE__*/function () {
    /**
     ...
     *   api - Editor.js API
     */
    function TimeStampImage(_ref) {
      var data = _ref.data,
          config = _ref.config,
          api = _ref.api,
          block = _ref.block;

      _classCallCheck(this, TimeStampImage);
    ...
    _createClass(TimeStampImage, [{
      ...
      value: function createImage() {
        ...
        image.onload = function () {
          ...
          if (_this.data.site_url && _this.data.site_url === window.location.href && _this.data.timeStamp) {
            playFromTimeStamp.addEventListener('click', function () {
              _this.config.onPlayClick(_this.data.timeStamp);
            });
        ...
        if (this.data.url) {
          ...
          loadButton.onchange = function (e) {
            ...
            _this.onDropHandler(file).then(function (data) {
              _this.data = data;
            });
      ...
      function onDropHandler(file) {
        ...
        return new Promise( /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
            var _yield$_this2$config$, url, key;
            ...
            return regenerator.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return _this2.config.fileUploader(file);

                  case 2:
                    _yield$_this2$config$ = _context.sent;
                    url = _yield$_this2$config$.url;
                    key = _yield$_this2$config$.key;
                    resolve({
                      url: url,
                      key: key,
                      caption: file.name
      ...
      function renderSettings() {
        ...
        this.settings.forEach(function (tune) {
          ...
          el.classList.add(_this4.CSS.settingsButton);
          el.innerHTML = tune.icon;
          el.addEventListener('click', function () {
            _this4._toggleTune(tune.name);

            el.classList.toggle(_this4.CSS.settingsButtonActive);
          });
          el.classList.toggle(_this4.CSS.settingsButtonActive, _this4.data[tune.name]);
      ...
      value: function _make(tagName) {
        ...
        var internalAtrributes = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
        ...
        for (var _attrName in internalAtrributes) {
          el.setAttribute(_attrName, internalAtrributes[_attrName]);
        }
      ...
      value: function _acceptTuneView() {
        ...
        this.settings.forEach(function (tune) {
          _this5.nodes.imageHolder.classList.toggle(_this5.CSS.imageHolder + '--' + tune.name.replace(/([A-Z])/g, function (g) {
            return "-".concat(g[0].toLowerCase());
          }), !!_this5.data[tune.name]);

          if (tune.name === 'stretched') {
            _this5.block.stretched = !!_this5.data.stretched;
          }
        });
      }
    }], [{
  ...
  var VideoPlayer = /*#__PURE__*/function () {
    ...
    _createClass(VideoPlayer, [{
      ...
      value: function _acceptTuneView() {
        ...
        this.settings.forEach(function (tune) {
          _this5.nodes.videoHolder.classList.toggle(_this5.CSS.videoHolder + '--' + tune.name.replace(/([A-Z])/g, function (g) {
            return "-".concat(g[0].toLowerCase());
          }), !!_this5.data[tune.name]);
          ...
          if (tune.name === 'controls') {
            _this5.nodes.video.controls = _this5.data.controls;
          }

          if (tune.name === 'autoplay') {
            _this5.nodes.video.autoplay = _this5.data.autoplay;
          }

          if (tune.name === 'muted') {
            _this5.nodes.video.muted = _this5.data.muted;
          }
        });
      }
    }], [{
  ...
  var RecordPlaceHolder = /*#__PURE__*/function () {
    /**
     * Render plugin`s main Element and fill it with saved data
     *
     * @param {{data: SimpleImageData, config: object, api: object}}
     ...
     *   api - Editor.js API
     */
    function RecordPlaceHolder(_ref) {
      _ref.data;
          var config = _ref.config,
          api = _ref.api,
          block = _ref.block;

      _classCallCheck(this, RecordPlaceHolder);
    ...
    _createClass(RecordPlaceHolder, [{
      key: "save",
      value: function save(blockContent) {
        return Object.assign(this.data, {});
      }
      ...
      function render() {
        ...
        this.nodes.button.addEventListener('click', function () {
          ...
          _this.config.onRecordClick(currentBlockIndex);
        });
  ...
  var getToolConfig = function getToolConfig(data, el, onPlayClick, fileUploader, onRecordClick, tools, otherConfig) {
  ...
  var Editor = /*#__PURE__*/function () {
    function Editor(data, el, onPlayClick, fileUploader, onRecordClick, tools, otherConfig) {
      _classCallCheck(this, Editor);

      this.config = getToolConfig(data, el, onPlayClick, fileUploader, onRecordClick, tools, otherConfig);
